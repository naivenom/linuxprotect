...
| -r | Displays RECON in LAN Network. Mode: -r scan |
...
| recon_scan | bash_ping: Ping sweep </br> nmap_ping: Ping sweep </br> nmap_scan: Scan TCP, verbose and determine open ports and services </br> |
